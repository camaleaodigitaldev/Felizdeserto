                    ...
                    >
                      ...
                      {doc.file_url ? (
                        <a
                          ...
                          className="inline-flex items-center gap-2 bg-brand-blue text-white text-xs font-semibold px-4 py-2.5 rounded-xl hover:bg-brand-blue-light transition-all duration-200 shadow-sm hover:shadow flex-shrink-0"
                        >
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
