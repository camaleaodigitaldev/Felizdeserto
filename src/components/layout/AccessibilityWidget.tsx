...
export default function AccessibilityWidget() {
  ...
  return (
    <div ref={ref} className="fixed bottom-6 left-4 z-[60] flex items-end justify-start">
      {/* Painel — abre para cima e para a esquerda */}
      {open && (
        <div className="absolute bottom-14 left-0 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden w-52 animate-fade-in">
