  ...
  return (
    <footer className="bg-brand-blue text-white mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-blue-200 text-sm leading-relaxed max-w-sm">
              ...
              <em className="text-brand-gold not-italic font-medium">{SITE.slogan}</em>
            </p>
          ...
          <div>
            ...
            <div className="mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-brand-green hover:bg-brand-green-light text-white text-xs font-medium px-4 py-2 rounded-lg transition-colors"
              >
      ...
      <div className="border-t border-white/10">
        <div className="container-site py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-blue-300">
          <p>
